...
List<FoodDetail> foodsItems = [
  ...
  FoodDetail(
    ...
    cookingTime: '05min',
    description:
        "This strawberry protein shake is creamy, easy to whip up and tastes like a milkshake, but is made with simple, natural ingredients and has over 20 grams of protein.",
  ),
  FoodDetail(
    id: '6',
    ...
    cookingTime: 'Ready',
    description:
        "Shop Cadbury Dairy Milk Silk Chocolate Bar, 150g Pack of 3 online at a best price. Get special offers, deals, discounts & fast delivery ...",
  ),
];
